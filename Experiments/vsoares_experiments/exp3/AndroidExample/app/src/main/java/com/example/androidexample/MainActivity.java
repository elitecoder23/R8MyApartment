...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pfpImage = findViewById(R.id.pfp);
        pfpImage.setVisibility(View.INVISIBLE);              // set profile picture invisible initially
        ChangeBtn = findViewById(R.id.change_pfp_btn);
        ...
        if(extras == null) {
            ...
            pfpImage.setVisibility(View.VISIBLE);                   // set profile picture visible
